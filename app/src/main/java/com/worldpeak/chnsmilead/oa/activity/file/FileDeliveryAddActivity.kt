...
import com.worldpeak.chnsmilead.databinding.ActivityFileDeliveryAddBinding
...
import com.worldpeak.chnsmilead.oa.viewmodel.file.FileDeliveryAddViewModel
import com.worldpeak.chnsmilead.util.*

/**
 * 新建文件下发
 */
class FileDeliveryAddActivity : BaseVmVBActivity<FileDeliveryAddViewModel, ActivityFileDeliveryAddBinding>() {
    ...
    override fun getLayoutId(): Int {
        return R.layout.activity_file_delivery_add
    }
    ...
    override fun initView() {
        ...
        mBinding.llSelectWay.setPreventDoubleClickListener {
            ...
            wayDialog = ListSelectConfirmDialog(this@FileDeliveryAddActivity, list, if (curIndex == -1) 0 else curIndex, false) { index ->
        ...
        mBinding.llSelectPerson.setPreventDoubleClickListener {
            OaContactActivity.startActivity(this, true, "文件详情")
        }
