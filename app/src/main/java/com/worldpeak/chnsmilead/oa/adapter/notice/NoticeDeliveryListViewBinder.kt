 ...
 * 通知下发
 */
class NoticeDeliveryListViewBinder(var context: Context?, val callback: (NoticeDeliveryItem) -> Unit) : ItemViewBinder<NoticeDeliveryItem, NoticeDeliveryListViewBinder.VH>() {
    ...
    override fun onBindViewHolder(holder: VH, entity: NoticeDeliveryItem) {
        ...
        mDataList.clear()
        entity.infoDowmAccessoryList?.let { mDataList.addAll(it) }
