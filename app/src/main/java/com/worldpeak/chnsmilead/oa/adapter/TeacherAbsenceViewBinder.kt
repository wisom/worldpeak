 ...
 * 教师缺勤
 */
class TeacherAbsenceViewBinder(var context: Context?) : ItemViewBinder<TeacherLeaveDetail, TeacherAbsenceViewBinder.VH>() {
    ...
    override fun onBindViewHolder(holder: VH, entity: TeacherLeaveDetail) {
        holder.tvName?.text = entity.userName
        holder.tvSchool?.text = entity.schoolName
        holder.tvClass?.text = entity.orgName
